                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <div class="delete-container">
                                <a href="/funcionario/delete?id=<?= $item->id ?>">
                                    <span class="iconify delete" data-icon="bi:trash" data-width="18" data-height="18"></span>
                                </a>
                            </div>


                            <div class="update-container">
                                <a class="text-decoration-none" href="/funcionario/form?id=<?= $item->id ?>">
                                    Editar
                                </a>
                            </div>
